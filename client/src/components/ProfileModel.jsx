  ...
  const {getToken} = useAuth();
   ...
   const handleSaveProfile = async(e)=>{
        ...
        try {
          ...
          const {username,bio,profile_picture,cover_photo,full_name,location} = editForm;
            ...
            <div className='bg-white rounded-lg shadow p-6'>
              ...
              <div>
               ...
               <div>
                ...
                <input type="text" className='w-full p-3 border border-gray-200 rounded-lg' placeholder='Please enter a location' 
              ...
              <div className='flex justify-end space-x-3 pt-6'>
                ...
                <button type='submit' className='px-4 py-2 bg-linear-to-r from-indigo-500 to-purple-600 text-white rounded-lg hover:from-indigo-600
